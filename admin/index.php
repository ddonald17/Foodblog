...
<head>
  ...
  <title>FoodBlog - Admin Panel</title>
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo">FoodBlog <span class="lite">Admin</span></a>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active">
            <a class="" href="index.php?managenewsteller">
                          <i class="icon_house_alt"></i>
                          <span>Manage newsteller</span>
                      </a>
          </li>          
...
<tr>
                    ...
                    <!-- <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-danger" href="../includes/removepost.php?id=<?=$comment['id']?>">Remove <i class="icon_close_alt2"></i></a>
                      </div>
                    </td> -->
                  </tr>
            <?php
        ...
        <?php
     }else if(isset($_GET['managenewsteller'])){
?>
<div class="row">
          <div class="col-lg-12">
            <section class="panel">
